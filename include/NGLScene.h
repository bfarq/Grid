...
private:
    ...
    enum class MeshType{TEAPOT, TROLL, CUBE, SPHERE};
    struct MeshData
    {
        ngl::Vec3 pos;
        ngl::Vec3 dir;
        ...
        MeshType type;
        float distance;
        MeshData (const ngl::Vec3 _pos, const ngl::Vec3 _scale, const ngl::Vec3 _rot, const ngl::Vec3 _colour, MeshType _type) : pos(_pos), scale(_scale), rot(_rot), colour(_colour), type(_type){}
        MeshData()=default;
